...
#define myLED_TRIS               TRISCbits.TRISC7
#define myLED_LAT                LATCbits.LATC7
#define myLED_PORT               PORTCbits.RC7
...
#define myLED_GetValue()           PORTCbits.RC7
#define myLED_SetDigitalInput()    do { TRISCbits.TRISC7 = 1; } while(0)
#define myLED_SetDigitalOutput()   do { TRISCbits.TRISC7 = 0; } while(0)
