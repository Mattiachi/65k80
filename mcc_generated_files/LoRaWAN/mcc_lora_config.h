...
/******************************* SPI ******************************************/
#define SPI_Initialize                      SPI_Initialize
#define SPI_Exchange8bit                    SPI_Exchange8bit
#define SPI_Exchange8bitBuffer              SPI_Exchange8bitBuffer
#define SPI_IsBufferFull                    SPI_IsBufferFull
#define SPI_HasWriteCollisionOccured        SPI_HasWriteCollisionOccured
#define SPI_ClearWriteCollisionStatus       SPI_ClearWriteCollisionStatus
/******************************* SPI ******************************************/
